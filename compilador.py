...
FALLBACKS_EDITEIS = [
    ...
    {
        "titulo": "Processo Seletivo IFBA 06/2026 - Mestrado Profissional em Tecnologias Aplicadas a Processos de Ensino",
        "resumo": "O IFBA Salvador abre seleção para o Mestrado Profissional em Tecnologias Aplicadas a Processos de Ensino e Aprendizagem. Curso direcionado ao desenvolvimento de softwares educativos, robótica pedagógica e formação docente com tecnologias digitais.",
        "instituicao": "IFBA",
        "nivel": "Mestrado Profissional",
        "area": "Tecnologia e Informática",
        "vagas": 20,
        ...
        "inscricoesInicio": "2026-06-15T09:00:00.000Z",
        "inscricoesFim": "2026-07-24T23:59:59.000Z",
        "dataPublicacao": "2026-06-05T08:00:00.000Z",
        "fonte": "IFBA Ensino"
    },
    {
...
def parse_periodo(periodo_str):
    parts = re.split(r'\s+a\s+', periodo_str, flags=re.IGNORECASE)
    hoje = datetime.now()
    start = hoje
    end = hoje
        ...
        for tr_match in tr_regex.finditer(html_content):
            ...
            if len(tds) >= 3:
                ...
                if has_date_range:
                    ...
                    if any(x in combined_lower for x in ["aluno especial", "matricula especial", "estudante especial", "disciplina isolada"]):
                        nivel = "Aluno Especial"
...
def buscar_novos_editais():
    ...
    queries = [
        f'site:ufba.br OR site:ufrb.edu.br OR site:ufsb.edu.br OR site:ufob.edu.br OR site:univasf.edu.br "mestrado" OR "doutorado" OR "aluno especial" {termo_anos}',
        f'site:uneb.br OR site:uefs.br OR site:uesc.br OR site:uesb.br OR site:ifba.edu.br OR site:ifbaiano.edu.br "mestrado" OR "doutorado" OR "aluno especial" {termo_anos}',
        f'site:unifacs.br OR site:ucsal.br OR site:unijorge.edu.br OR site:uniftc.edu.br "mestrado" OR "doutorado" OR "aluno especial" {termo_anos}'
    ]
